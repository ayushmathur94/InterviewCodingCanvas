...
public class CandiesDistributionProblemRevision {

	private static long candiesProb(int arr[], int n){
	...
	public static void main(String[] args) {
		...
		//int inputarr[] = {2,4,5,6,8,9,2,5,7,9};
		int inputarr[] = {2,4,6,7,8,9,10,2};
		int n = inputarr.length;
		
		System.out.println(candiesProb(inputarr,n));
